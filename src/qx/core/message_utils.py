...
def qx_to_langchain_messages(qx_messages: List[Dict[str, Any]], 
                            include_system: bool = True,
                            system_prompt: str = "") -> List[BaseMessage]:
    """
...
def langchain_to_qx_messages(langchain_messages: List[BaseMessage]) -> List[Dict[str, Any]]:
    """
...
def prepare_messages_for_model(messages: List[BaseMessage], 
                              system_prompt: str = "",
                              skip_system_messages: bool = False) -> List[BaseMessage]:
    """
